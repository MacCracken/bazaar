...
- CI installs Cyrius 6.0.3 on every run from the published release tarball, pinned by `cyrius = "..."` in `cyrius.cyml`. Single network dependency.
...
- Cyrius 6.0.3 `lib/toml.cyr`, `lib/fs.cyr`, `lib/args.cyr`
