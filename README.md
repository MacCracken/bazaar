...
**Current release:** [`1.0.5`](./VERSION) — versioned [in lockstep with zugot](docs/adr/006-zugot-as-cyrius-dep.md); each bazaar tag validates against the matching zugot tag.
...
# Build the validator (requires cyrius 6.2.12+)
